...
> **Make sure the token header has `kid` and `alg`**
>
...
See this test to [understand how to generate and encrypt payloads](https://github.com/pucora/pucora-jose/blob/master/jwk_test.go).
