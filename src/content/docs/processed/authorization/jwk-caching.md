...
> **Caching does not apply to `jwk_local_path`**
>
...
> **Schema reference:** `auth/validator.json` — see [pucora-schema](https://github.com/pucora/pucora-schema).
...
> **Schema reference:** `auth/jose.json` — see [pucora-schema](https://github.com/pucora/pucora-schema).



> **The `cache` flag is still required**
>
