...
> **Schema reference:** `endpoint.json` — see [pucora-schema](https://github.com/pucora/pucora-schema).
...
> **Schema reference:** `endpoint_extra_config.json` — see [pucora-schema](https://github.com/pucora/pucora-schema).