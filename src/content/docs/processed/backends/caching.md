...
> **Schema reference:** `backend_extra_config.json` — see [pucora-schema](https://github.com/pucora/pucora-schema).
...
> **Configurations not eligible for caching**
>
