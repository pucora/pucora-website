...
> **Looking for a Query Language manipulation?**
>
> 
...
> **The flatmap at the endpoint level requires multiple backends**
>
...
> **Schema reference:** `proxy/flatmap.json` — see [pucora-schema](https://github.com/pucora/pucora-schema).
