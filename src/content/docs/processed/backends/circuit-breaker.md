...
> **Schema reference:** `qos/circuit-breaker.json` — see [pucora-schema](https://github.com/pucora/pucora-schema).
...
*[Image: /images/documentation/circuit-breaker.png]*
...
> **`no-op` endpoints do not check HTTP status codes**
>
