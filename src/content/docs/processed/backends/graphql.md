...
*[Image: /images/documentation/graphql/pucora-rest-to-graphql-transformation.png]*
...
> **Schema reference:** `backend/graphql.json` — see [pucora-schema](https://github.com/pucora/pucora-schema).
...
*[Image: /images/documentation/graphql/pucora-graphql-proxy.png]*
