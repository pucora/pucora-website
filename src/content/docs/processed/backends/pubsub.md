...
> **Schema reference:** `backend/pubsub/subscriber.json` — see [pucora-schema](https://github.com/pucora/pucora-schema).
...
> **Schema reference:** `backend/pubsub/publisher.json` — see [pucora-schema](https://github.com/pucora/pucora-schema).
