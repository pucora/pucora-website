...
> **Schema reference:** `telemetry/metrics.json` — see [pucora-schema](https://github.com/pucora/pucora-schema).
...
> **Schema reference:** `telemetry/influx.json` — see [pucora-schema](https://github.com/pucora/pucora-schema).
...
services:
  ...
  pucora:
    image: pucora/pucora-ce:latest:2.0
    volumes:
      - ./pucora:/etc/pucora
    ports:
      - "8080:8080"
